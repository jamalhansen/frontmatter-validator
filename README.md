...
```bash
uv run fm-validate validate path/to/post.md
```

### Validate a directory
```bash
uv run fm-validate validate path/to/content/
```
...
```bash
uv run fm-validate validate path/to/post.md --template-dir ~/vaults/BrainSync/Templates
```
...
```bash
uv run fm-validate validate path/to/post.md --clean
```
...
```bash
uv run fm-validate validate path/to/post.md --verbose
```
